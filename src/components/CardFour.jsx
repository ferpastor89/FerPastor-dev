    ...
    <div className="w-80 mx-auto bg-white rounded-full">
      <article className="overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900 dark:shadow-gray-700/25">
        ...
        <div className="p-4 sm:p-6">
          ...
          <a class="text-black" href="https://github.com/ferpastor89/PaginaDescargaCVFerPastor" target="_blank">
          ...
          <div class="link-preview flex pl-14 pt-4">
            <a class="text-black" href="https://ferdownloadcv.web.app/" target="_blank">
            ...
            <a class="link pt-1 pl-1" href="https://ferdownloadcv.web.app/" target="_blank">Preview</a>
          </div>
          </div>
